# USAGE
# python3 recognize_faces_image.py --encodings encodings.pickle --image test_images/sample18.jpg
...
for encoding in encodings:
    ...
    matches = face_recognition.compare_faces(data["encodings"], encoding, 0.6)      # có thể điều chỉnh tham số cuối
    ...
    del name, matches, counts, matchedIdxs
...
for ((top, right, bottom, left), name) in zip(boxes, names):
    ...
    cv2.putText(image, name, (left, y), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 1)
