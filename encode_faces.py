...
for (i, imagePath) in enumerate(imagePaths):
    ...
    # load ảnh bằng OpenCV và convert từ BGR sang RGB
    ...
    # dùng "cnn" chính xác hơn nhưng chậm hơn, "hog" nhanh hơn nhưng kém chính xác hơn
    ...
    t2 = time.time()
    print("[INFO] image processing time: {}s".format(t2-t1))
    totaltime += float(t2-t1)
    del boxes, encodings
...
print("[INFO] total time: {}s".format(totaltime))
